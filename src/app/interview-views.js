...
function vIvHome(){
  ...
  return '<p class="mode-intro">Банк собран из профессионального чата, где соискатели выкладывают вопросы сразу после интервью. '+
    'Имён и названий компаний в базе нет — только сами вопросы.</p>'+
